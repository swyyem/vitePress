...
import { ProForm, ProField, ProFormSwitch } from '../../index'
...
const meta = {
  title: 'Example/ProFormFields/ProFormSwitch',
  component: ProForm,
  tags: ['autodocs'],
  argTypes: {
    submitter: {
...
export const Basic: Story = {
  render: () => ({
    components: { ProFormSwitch, ElButton, ProForm, ProField, Calendar, ElIcon },
    setup() {
      return {
        handleSubmit,
        handleChange,
...
export const Mode: Story = {
  render: () => ({
    components: { ProFormSwitch, ElButton, ProForm, ProField, Calendar, ElIcon, ElRow },
    setup() {
