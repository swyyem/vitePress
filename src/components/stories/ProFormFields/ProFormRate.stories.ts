...
import { ProForm, ProField, ProFormRate } from '../../index'
...
const meta = {
  title: 'Example/ProFormFields/ProFormRate',
  component: ProForm,
  tags: ['autodocs'],
  argTypes: {
    submitter: {
...
export const Basic: Story = {
  render: () => ({
    components: { ProFormRate, ElButton, ProForm, ProField, Calendar, ElIcon },
    setup() {
      return {
        handleSubmit,
        handleChange,
...
export const Mode: Story = {
  render: () => ({
    components: { ProFormRate, ElButton, ProForm, ProField, Calendar, ElIcon, ElRow },
    setup() {
