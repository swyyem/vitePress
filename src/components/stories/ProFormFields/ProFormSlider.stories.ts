...
import { ProForm, ProField, ProFormSlider } from '../../index'
...
const meta = {
  title: 'Example/ProFormFields/ProFormSlider',
  component: ProForm,
  tags: ['autodocs'],
  argTypes: {
    submitter: {
...
export const Basic: Story = {
  render: () => ({
    components: { ProFormSlider, ElButton, ProForm, ProField, Calendar, ElIcon },
    setup() {
      return {
        handleSubmit,
        handleChange,
...
export const Mode: Story = {
  render: () => ({
    components: { ProFormSlider, ElButton, ProForm, ProField, Calendar, ElIcon, ElRow },
    setup() {
