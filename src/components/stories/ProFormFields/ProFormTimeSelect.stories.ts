...
import { ProForm, ProField, ProFormTimeSelect } from '../../index'
...
const meta = {
  title: 'Example/ProFormFields/ProFormTimeSelect',
  component: ProForm,
  tags: ['autodocs'],
  argTypes: {
    submitter: {
...
export const Basic: Story = {
  render: () => ({
    components: { ProFormTimeSelect, ElButton, ProForm, ProField, Calendar, ElIcon },
    setup() {
      return {
        handleSubmit,
        handleChange,
...
export const Mode: Story = {
  render: () => ({
    components: { ProFormTimeSelect, ElButton, ProForm, ProField, Calendar, ElIcon, ElRow },
    setup() {
