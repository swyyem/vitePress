...
import { ProForm, ProField, ProFormTextArea } from '../../index'
...
const meta = {
  title: 'Example/ProFormFields/ProFormTextarea',
  component: ProForm,
  tags: ['autodocs'],
  argTypes: {
    submitter: {
...
export const Basic: Story = {
  render: () => ({
    components: { ProFormTextArea, ElButton, ProForm, ProField, Calendar, ElIcon },
    setup() {
      return {
        handleSubmit,
        handleChange,
...
export const Mode: Story = {
  render: () => ({
    components: { ProFormTextArea, ElButton, ProForm, ProField, Calendar, ElIcon, ElRow },
    setup() {
