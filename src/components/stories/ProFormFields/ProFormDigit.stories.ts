...
import { ProForm, ProFormDigit } from '../../index'

import type { ProFieldPropsType } from '../../proField/index.type'
import { ref, h } from 'vue'

const meta = {
  title: 'Example/ProFormFields/ProFormDigit',
  component: ProForm,
  tags: ['autodocs'],
  argTypes: {
    submitter: {
...
export const Basic: Story = {
  render: () => ({
    components: { ProFormDigit, ProForm },
    setup() {
      return {
        handleSubmit,
        handleChange,
...
export const Mode: Story = {
  render: () => ({
    components: { ProFormDigit, ElButton, ProForm, ElRow },
    setup() {
...
export const FieldProps: Story = {
  render: () => ({
    components: { ProFormDigit, ElButton, ProForm },
    setup() {
      return {
        handleSubmit,
        handleChange,
