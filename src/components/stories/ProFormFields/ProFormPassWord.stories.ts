...
import { ProForm, ProFormPassWord } from '../../index'

import type { ProFieldPropsType } from '../../proField/index.type'
import { ref, h } from 'vue'

const meta = {
  title: 'Example/ProFormFields/ProFormPassWord',
  component: ProForm,
  tags: ['autodocs'],
  argTypes: {
    submitter: {
...
export const Basic: Story = {
  render: () => ({
    components: { ProFormPassWord, ProForm },
    setup() {
      return {
        handleSubmit,
        handleChange,
...
export const Mode: Story = {
  render: () => ({
    components: { ProFormPassWord, ElButton, ProForm, ElRow },
    setup() {
...
export const FieldProps: Story = {
  render: () => ({
    components: { ProFormPassWord, ElButton, ProForm },
    setup() {
      return {
        handleSubmit,
        handleChange,
