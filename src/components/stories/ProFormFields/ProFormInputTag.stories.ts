...
import { ProForm, ProFormInputTag } from '../../index'

import type { ProFieldPropsType } from '../../proField/index.type'
import { ref, h } from 'vue'

const meta = {
  title: 'Example/ProFormFields/ProFormInputTag',
  component: ProForm,
  tags: ['autodocs'],
  argTypes: {
    submitter: {
...
export const Basic: Story = {
  render: () => ({
    components: { ProFormInputTag, ProForm },
    setup() {
      return {
        handleSubmit,
        handleChange,
...
export const Mode: Story = {
  render: () => ({
    components: { ProFormInputTag, ElButton, ProForm, ElRow },
    setup() {
...
export const FieldProps: Story = {
  render: () => ({
    components: { ProFormInputTag, ElButton, ProForm },
    setup() {
      return {
        handleSubmit,
        handleChange,
    ...
    <h3>基础用法</h3>
      ...
      >
        <ProFormInputTag
          ...
          v-bind="IPropsData"
          >
          <template #tag="{ value: string, index: number }">
            value
          </template>
          <template #prefix>
            prefix
