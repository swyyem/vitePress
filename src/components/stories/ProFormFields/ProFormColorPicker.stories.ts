...
import { ProForm, ProFormColorPicker } from '../../index'

import type { ProFieldPropsType } from '../../proField/index.type'
import { ref, h } from 'vue'

const meta = {
  title: 'Example/ProFormFields/ProFormColorPicker',
  component: ProForm,
  tags: ['autodocs'],
  argTypes: {
    submitter: {
...
export const Basic: Story = {
  render: () => ({
    components: { ProFormColorPicker, ProForm },
    setup() {
      return {
        handleSubmit,
        handleChange,
...
export const Mode: Story = {
  render: () => ({
    components: { ProFormColorPicker, ElButton, ProForm, ElRow },
    setup() {
...
export const FieldProps: Story = {
  render: () => ({
    components: { ProFormColorPicker, ElButton, ProForm },
    setup() {
      return {
        handleSubmit,
        handleChange,
