...
import { ProForm, ProField, ProFormTimePicker } from '../../index'
...
const meta = {
  title: 'Example/ProFormFields/ProFormTimePicker',
  component: ProFormTimePicker,
  tags: ['autodocs'],
  argTypes: {},
  parameters: {
    docs: {
      description: {
        component: '基于 ElTimePicker 封装的组件',
      },
      type: {
        // 自动生成类型文档
        showType: true,
...
} satisfies Meta<typeof ProFormTimePicker>

export default meta
type Story = StoryObj<typeof ProFormTimePicker>
...
export const Basic: Story = {
  render: () => ({
    components: { ProFormTimePicker, ElButton, ProForm, ProField, Calendar, ElIcon },
    setup() {
      return {
        handleSubmit,
        handleChange,
...
export const Mode: Story = {
  render: () => ({
    components: { ProFormTimePicker, ElButton, ProForm, ProField, Calendar, ElIcon, ElRow },
    setup() {
