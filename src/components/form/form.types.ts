...
export type EffectType = {
  ...
  decorator?: {
    display?:
      | string
      | ((ctx: EffectContextType, value: ProFormValueType) => DisplayEnum);
    value?: string | ((ctx: EffectContextType, value: ProFormValueType) => any);
    required?:
      | string
      | ((ctx: EffectContextType, value: ProFormValueType) => boolean);
    rules?:
      | string
      | ((
          ctx: EffectContextType,
          value: ProFormValueType
        ) => FormItemProps["rules"]);
    valueEnum?:
      | string
      | ((ctx: EffectContextType, value: ProFormValueType) => any[]);
  };
  /** ProFormField 内子组件的配置 */
  component?: Partial<
    Record<string, string | ((ctx: EffectContextType) => any)>
  >;
  /** 异步一对多的场景 */
  batchLogic?: (
    v: ProFormValueType,
...
export type FiledForm = PropFormFieldProps &
  Omit<
    ProFieldPropsType,
    "mode" | "fieldProps" | "valueEnum" | "request" | "valueType"
  > & {
