...
> = ProCellRendererParams &
  Pick<ProColumn, 'required' | 'editable' | 'cellRenderer' | 'editCellRenderer'> &
...
const rowKeyValue = computed(() => getRealRowKey(getRowKey.value, rowData.value) as string);
...
const cellClass = computed(() => {
  ...
  const checkboxClass = props.column.valueType === 'checkbox' ? 'pro-column--checkbox' : '';
