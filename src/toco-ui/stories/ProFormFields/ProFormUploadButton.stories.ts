...
import { ProForm, ProField, ProFormUploadButton } from '../../index';
...
const meta = {
  title: 'Example/ProFormFields/ProFormUploadButton',
  ...
  parameters: {
    docs: {
      description: {
        component: '基于 ElementPlus 封装的 upload 组件',
      },
      type: {
        // 自动生成类型文档
        showType: true,
...
} satisfies Meta<typeof ProFormUploadButton>;

export default meta;
type Story = StoryObj<typeof ProFormUploadButton>;
...
export const Basic: Story = {
  render: () => ({
    components: { ProFormUploadButton, ElButton, ProForm, ProField, Calendar, ElIcon },
    setup() {
      return {
        handleSubmit,
        handleChange,
...
export const Mode: Story = {
  render: () => ({
    components: { ProFormUploadButton, ElButton, ProForm, ProField, Calendar, ElIcon, ElRow },
    setup() {
