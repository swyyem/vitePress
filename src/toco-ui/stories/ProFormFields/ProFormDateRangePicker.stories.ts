...
import { ProForm, ProFormDateRangePicker } from '../../index';
...
const meta = {
  title: 'Example/ProFormFields/ProFormDateRangePicker',
  component: ProForm,
  tags: ['autodocs'],
  argTypes: {
    submitter: {
...
export const Basic: Story = {
  render: () => ({
    components: { ProFormDateRangePicker, ProForm },
    setup() {
      return {
        handleSubmit,
        handleChange,
...
export const Mode: Story = {
  render: () => ({
    components: { ProFormDateRangePicker, ElButton, ProForm, ElRow },
    setup() {
...
export const FieldProps: Story = {
  render: () => ({
    components: { ProFormDateRangePicker, ElButton, ProForm },
    setup() {
      return {
        handleSubmit,
        handleChange,
...
export const Slot: Story = {
  render: () => ({
    components: { ProFormDateRangePicker, ProForm, Plus, Minus, Female, Male },
    setup() {
      return {
        handleSubmit,
        handleChange,
