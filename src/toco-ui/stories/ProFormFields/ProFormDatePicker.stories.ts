...
import { ProForm, ProFormDatePicker } from '../../index';
...
const meta = {
  title: 'Example/ProFormFields/ProFormDatePicker',
...
} satisfies Meta<typeof ProFormDatePicker>;

export default meta;
type Story = StoryObj<typeof ProFormDatePicker>;
...
export const Basic: Story = {
  render: () => ({
    components: { ProFormDatePicker, ProForm },
    setup() {
      return {
        handleSubmit,
        handleChange,
...
export const Mode: Story = {
  render: () => ({
    components: { ProFormDatePicker, ElButton, ProForm, ElRow },
    setup() {
...
export const FieldProps: Story = {
  render: () => ({
    components: { ProFormDatePicker, ElButton, ProForm },
    setup() {
      return {
        handleSubmit,
        handleChange,
...
export const Slot: Story = {
  render: () => ({
    components: { ProFormDatePicker, ProForm, Plus, Minus, Female, Male },
    setup() {
      return {
        handleSubmit,
        handleChange,
