...
import { ProForm, ProFormDateTimeRangePicker } from '../../index';
...
const meta = {
  title: 'Example/ProFormFields/ProFormDateTimeRangePicker',
  component: ProForm,
  tags: ['autodocs'],
  argTypes: {
    submitter: {
...
export const Basic: Story = {
  render: () => ({
    components: { ProFormDateTimeRangePicker, ProForm },
    setup() {
      return {
        handleSubmit,
        handleChange,
...
export const Mode: Story = {
  render: () => ({
    components: { ProFormDateTimeRangePicker, ElButton, ProForm, ElRow },
    setup() {
...
export const FieldProps: Story = {
  render: () => ({
    components: { ProFormDateTimeRangePicker, ElButton, ProForm },
    setup() {
      return {
        handleSubmit,
        handleChange,
...
export const Slot: Story = {
  render: () => ({
    components: { ProFormDateTimeRangePicker, ProForm, Plus, Minus, Female, Male },
    setup() {
      return {
        handleSubmit,
        handleChange,
