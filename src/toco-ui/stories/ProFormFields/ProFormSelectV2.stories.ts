...
import { ProForm, ProField, ProFormSelectV2 } from '../../index';
...
const meta = {
  title: 'Example/ProFormFields/ProFormSelectV2',
  component: ProForm,
  tags: ['autodocs'],
  argTypes: {
    submitter: {
...
export const Basic: Story = {
  render: () => ({
    components: { ProFormSelectV2, ElButton, ProForm, ProField, Calendar, ElIcon },
    setup() {
      return {
        handleSubmit,
        handleChange,
...
export const Mode: Story = {
  render: () => ({
    components: { ProFormSelectV2, ElButton, ProForm, ProField, Calendar, ElIcon, ElRow },
    setup() {
...
export const Slot: Story = {
  render: () => ({
    components: { ProFormSelectV2, ProForm },
    setup() {
      return {
        handleSubmit,
        handleChange,
