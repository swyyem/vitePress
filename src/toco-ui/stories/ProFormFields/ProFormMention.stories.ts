...
import { ProForm, ProFormMention } from '../../index';
...
const meta = {
  title: 'Example/ProFormFields/ProFormMention',
  component: ProForm,
  tags: ['autodocs'],
  argTypes: {
    submitter: {
...
export const Basic: Story = {
  render: () => ({
    components: { ProFormMention, ProForm },
    setup() {
      return {
        handleSubmit,
        handleChange,
...
export const Mode: Story = {
  render: () => ({
    components: { ProFormMention, ElButton, ProForm, ElRow },
    setup() {
...
export const FieldProps: Story = {
  render: () => ({
    components: { ProFormMention, ElButton, ProForm },
    setup() {
      return {
        handleSubmit,
        handleChange,
