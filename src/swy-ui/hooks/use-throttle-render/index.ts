...
import { isNumber, isObject, isUndefined } from '@swy-ui/utils'

import type { Ref } from 'vue'

export type ThrottleType = { leading?: number; trailing?: number; initVal?: boolean } | number

export const useThrottleRender = (loading: Ref<boolean>, throttle: ThrottleType = 0) => {
