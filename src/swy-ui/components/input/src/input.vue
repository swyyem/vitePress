        ...
        <span v-if="suffixVisible" :class="nsInput.e('suffix')">
          <span :class="nsInput.e('suffix-inner')">
            ...
            <span
              ...
              :class="[nsInput.e('count'), nsInput.is('outside', wordLimitPosition === 'outside')]"
            >
...
import {
  ...
  useFormItemInputId,
  useFormSize,
} from '@swy-ui/components/form'
import { NOOP, ValidateComponentsMap, debugWarn, isClient, isObject } from '@swy-ui/utils'
import {
  useAttrs,
  useComposition,
  useCursor,
...
import { CHANGE_EVENT, INPUT_EVENT, UPDATE_MODEL_EVENT } from '@swy-ui/constants'
...
const resizeTextarea = () => {
  ...
  if (autosize) {
    ...
    nextTick(() => {
      ...
      const _ = textarea.value!.offsetHeight
      console.warn(_)
