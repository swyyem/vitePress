...
export const useSlider = (props: SliderProps, { key, minValue, maxValue }: UseSliderOptions) => {
...
export const useSliderDOM = (
  props: SliderProps,
  { namespace, maxValue, bar, thumb, currentValue, handleDrag, getBackground }: UseSliderDOMOptions
) => {
  const instance = getCurrentInstance()!
