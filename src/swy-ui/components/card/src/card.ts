/** File: card.ts - TypeScript File */

// ========== Dependencies Import ==========
import { buildProps, definePropType } from '@swy-ui/utils'

import type { ExtractPropTypes, InjectionKey, StyleValue, ExtractPublicPropTypes } from 'vue'
...
export const cardContextKey: InjectionKey<CardConfigContext> = Symbol('cardContextKey')
