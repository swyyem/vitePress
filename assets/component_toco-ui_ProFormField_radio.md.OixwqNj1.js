import{d as u,p as d,B as n,b as C,o as g,w as e,G as p,M as m,c as v,j as i,a as s}from"./chunks/framework.CtsLwA2Q.js";const F=u({__name:"radio.md.demo.70e49cc9",setup(y){const r=l=>{console.log("提交数据：",l)},a=(l,h)=>{console.log("valueChange",l,h)},k=[{target:"name",decorator:{display:"ctx.$self.value === '123' ? 'none' : 'visible'"}}],t={username:"Fuphoenixes"},o=d([{label:"Fuphoenixes",value:"Fuphoenixes"},{label:"kooriookami",value:"kooriookami"},{label:"Jeremy",value:"Jeremy"},{label:"btea",value:"btea"}]),B=d({name:"username",label:"用户名1",effects:k,valueType:"radio",labelWidth:"80px",fieldProps:{options:o}});return(l,h)=>{const c=n("ProFormField"),D=n("ProForm");return g(),C(D,{initialValues:t,autoFocusFirstInput:!0,onSubmit:r,onValuesChange:a},{default:e(()=>[p(c,m({modelValue:t.username,"onUpdate:modelValue":h[0]||(h[0]=A=>t.username=A)},B.value),null,16,["modelValue"])]),_:1})}}}),P=JSON.parse('{"title":"单选框组件","description":"","frontmatter":{},"headers":[],"relativePath":"component/toco-ui/ProFormField/radio.md","filePath":"component/toco-ui/ProFormField/radio.md"}'),b={name:"component/toco-ui/ProFormField/radio.md"},x=Object.assign(b,{setup(y){return(r,a)=>{const k=n("demo");return g(),v("div",null,[a[1]||(a[1]=i("h1",{id:"单选框组件",tabindex:"-1"},[s("单选框组件 "),i("a",{class:"header-anchor",href:"#单选框组件","aria-label":'Permalink to "单选框组件"'},"​")],-1)),p(k,{customClass:"demoblock-custom",sourceCode:`<template>
  <ProForm
