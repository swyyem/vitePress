import{d as D,p as A,B as n,b as u,o as d,w as e,G as p,M as C,c as m,j as i,a as s}from"./chunks/framework.KoO-uqrk.js";const v=D({__name:"selectV2.md.demo.7101625d",setup(g){const r=l=>{console.log("提交数据：",l)},a=(l,h)=>{console.log("valueChange",l,h)},k=[{target:"name",decorator:{display:"ctx.$self.value === '123' ? 'none' : 'visible'"}}],t={username:"Option3"},y=A({name:"username",label:"用户名1",effects:k,valueType:"selectV2",labelWidth:"80px",fieldProps:{options:[{value:"Option1",label:"Option1"},{value:"Option2",label:"Option2"},{value:"Option3",label:"Option3"},{value:"Option4",label:"Option4"},{value:"Option5",label:"Option5"}]}});return(l,h)=>{const o=n("ProFormField"),B=n("ProForm");return d(),u(B,{initialValues:t,autoFocusFirstInput:!0,onSubmit:r,onValuesChange:a},{default:e(()=>[p(o,C({modelValue:t.username,"onUpdate:modelValue":h[0]||(h[0]=c=>t.username=c)},y.value),null,16,["modelValue"])]),_:1})}}}),O=JSON.parse('{"title":"虚拟下拉选择组件","description":"","frontmatter":{},"headers":[],"relativePath":"component/ProFormField/selectV2.md","filePath":"component/ProFormField/selectV2.md"}'),f={name:"component/ProFormField/selectV2.md"},V=Object.assign(f,{setup(g){return(r,a)=>{const k=n("demo");return d(),m("div",null,[a[1]||(a[1]=i("h1",{id:"虚拟下拉选择组件",tabindex:"-1"},[s("虚拟下拉选择组件 "),i("a",{class:"header-anchor",href:"#虚拟下拉选择组件","aria-label":'Permalink to "虚拟下拉选择组件"'},"​")],-1)),p(k,{customClass:"demoblock-custom",sourceCode:`<template>
  <ProForm
