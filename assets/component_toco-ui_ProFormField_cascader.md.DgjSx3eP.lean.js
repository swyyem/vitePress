import{d as A,p as D,B as t,b as u,o as d,w as e,G as p,M as C,c as v,j as i,a as s}from"./chunks/framework.CtsLwA2Q.js";const m=A({__name:"cascader.md.demo.69e1966e",setup(g){const r=h=>{console.log("提交数据：",h)},a=(h,k)=>{console.log("valueChange",h,k),console.log("initialValues=",l)},n=[{target:"name",decorator:{display:"ctx.$self.value === '123' ? 'none' : 'visible'"}}],l={username:"consistency"},y=D({name:"username",label:"用户名1",effects:n,valueType:"cascader",labelWidth:"80px",fieldProps:{options:[{value:"guide",label:"Guide",children:[{value:"disciplines",label:"Disciplines",children:[{value:"consistency",label:"Consistency"},{value:"feedback",label:"Feedback"},{value:"efficiency",label:"Efficiency"},{value:"controllability",label:"Controllability"}]},{value:"navigation",label:"Navigation",children:[{value:"side nav",label:"Side Navigation"},{value:"top nav",label:"Top Navigation"}]}]}],props:{expandTrigger:"hover"}}});return(h,k)=>{const c=t("ProFormField"),o=t("ProForm");return d(),u(o,{initialValues:l,autoFocusFirstInput:!0,onSubmit:r,onValuesChange:a},{default:e(()=>[p(c,C({modelValue:l.username,"onUpdate:modelValue":k[0]||(k[0]=B=>l.username=B)},y.value),null,16,["modelValue"])]),_:1})}}}),V=JSON.parse('{"title":"级联选择器组件","description":"","frontmatter":{},"headers":[],"relativePath":"component/toco-ui/ProFormField/cascader.md","filePath":"component/toco-ui/ProFormField/cascader.md"}'),b={name:"component/toco-ui/ProFormField/cascader.md"},E=Object.assign(b,{setup(g){return(r,a)=>{const n=t("demo");return d(),v("div",null,[a[1]||(a[1]=i("h1",{id:"级联选择器组件",tabindex:"-1"},[s("级联选择器组件 "),i("a",{class:"header-anchor",href:"#级联选择器组件","aria-label":'Permalink to "级联选择器组件"'},"​")],-1)),p(n,{customClass:"demoblock-custom",sourceCode:`<template>
  <ProForm
