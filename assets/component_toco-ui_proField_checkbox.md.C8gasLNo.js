import{d as c,p as B,B as p,b as D,o as r,c as A,j as i,G as t,a as s,w as e}from"./chunks/framework.CtsLwA2Q.js";const C=c({__name:"checkbox.md.demo.b4695222",setup(d){const a=B([]),l={expandTrigger:"hover"},h=k=>{console.log(k)},g=[{value:"consistency",label:"Consistency"},{value:"feedback",label:"Feedback"},{value:"efficiency",label:"Efficiency"},{value:"controllability",label:"Controllability"}];return(k,n)=>{const y=p("ProField");return r(),D(y,{valueType:"checkbox",modelValue:a.value,"onUpdate:modelValue":n[0]||(n[0]=o=>a.value=o),fieldProps:{options:g,props:l,onChange:h}},null,8,["modelValue","fieldProps"])}}}),m=JSON.parse('{"title":"复选框组件","description":"","frontmatter":{},"headers":[],"relativePath":"component/toco-ui/proField/checkbox.md","filePath":"component/toco-ui/proField/checkbox.md"}'),u={name:"component/toco-ui/proField/checkbox.md"},b=Object.assign(u,{setup(d){return(a,l)=>{const h=p("demo");return r(),A("div",null,[l[1]||(l[1]=i("h1",{id:"复选框组件",tabindex:"-1"},[s("复选框组件 "),i("a",{class:"header-anchor",href:"#复选框组件","aria-label":'Permalink to "复选框组件"'},"​")],-1)),t(h,{customClass:"demoblock-custom",sourceCode:`<template>
  <ProField
    valueType="checkbox"
    v-model="value"
    :fieldProps="{
