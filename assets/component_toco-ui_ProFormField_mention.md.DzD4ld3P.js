import{d as u,p as d,B as n,b as m,o as g,w as e,G as p,M as C,c as v,j as i,a as s}from"./chunks/framework.CtsLwA2Q.js";const b=u({__name:"mention.md.demo.64b71790",setup(y){const r=l=>{console.log("提交数据：",l)},a=(l,h)=>{console.log("valueChange",l,h)},k=[{target:"name",decorator:{display:"ctx.$self.value === '123' ? 'none' : 'visible'"}}],t={username:"@"},o=d([{label:"Fuphoenixes",value:"Fuphoenixes"},{label:"kooriookami",value:"kooriookami"},{label:"Jeremy",value:"Jeremy"},{label:"btea",value:"btea"}]),B=d({name:"username",label:"用户名1",effects:k,valueType:"mention",labelWidth:"80px",fieldProps:{options:o,placeholder:"Please Input"}});return(l,h)=>{const c=n("ProFormField"),D=n("ProForm");return g(),m(D,{initialValues:t,autoFocusFirstInput:!0,onSubmit:r,onValuesChange:a},{default:e(()=>[p(c,C({modelValue:t.username,"onUpdate:modelValue":h[0]||(h[0]=A=>t.username=A)},B.value),null,16,["modelValue"])]),_:1})}}}),P=JSON.parse('{"title":"提及组件","description":"","frontmatter":{},"headers":[],"relativePath":"component/toco-ui/ProFormField/mention.md","filePath":"component/toco-ui/ProFormField/mention.md"}'),F={name:"component/toco-ui/ProFormField/mention.md"},_=Object.assign(F,{setup(y){return(r,a)=>{const k=n("demo");return g(),v("div",null,[a[1]||(a[1]=i("h1",{id:"提及组件",tabindex:"-1"},[s("提及组件 "),i("a",{class:"header-anchor",href:"#提及组件","aria-label":'Permalink to "提及组件"'},"​")],-1)),p(k,{customClass:"demoblock-custom",sourceCode:`<template>
  <ProForm
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#999999","--shiki-dark":"#666666"}},"  },")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#999999","--shiki-dark":"#666666"}},"})")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#999999","--shiki-dark":"#666666"}},"</"),i("span",{style:{"--shiki-light":"#1E754F","--shiki-dark":"#4D9375"}},"script"),i("span",{style:{"--shiki-light":"#999999","--shiki-dark":"#666666"}},">")])])])],-1)])),default:e(()=>[p(b)]),_:1})])}}});export{P as __pageData,_ as default};
