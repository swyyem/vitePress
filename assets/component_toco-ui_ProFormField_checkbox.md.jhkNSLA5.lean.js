import{d as D,p as A,B as n,b as u,o as d,w as e,G as p,M as C,c as m,j as i,a as s}from"./chunks/framework.CtsLwA2Q.js";const f=D({__name:"checkbox.md.demo.087cffb3",setup(y){const r=l=>{console.log("提交数据：",l)},a=(l,h)=>{console.log("valueChange",l,h)},k=[{target:"name",decorator:{display:"ctx.$self.value === '123' ? 'none' : 'visible'"}}],t={username:"feedback"},g=A({name:"username",label:"用户名1",effects:k,valueType:"checkbox",labelWidth:"80px",fieldProps:{options:[{value:"consistency",label:"Consistency"},{value:"feedback",label:"Feedback"},{value:"efficiency",label:"Efficiency"},{value:"controllability",label:"Controllability"}]}});return(l,h)=>{const o=n("ProFormField"),c=n("ProForm");return d(),u(c,{initialValues:t,autoFocusFirstInput:!0,onSubmit:r,onValuesChange:a},{default:e(()=>[p(o,C({modelValue:t.username,"onUpdate:modelValue":h[0]||(h[0]=B=>t.username=B)},g.value),null,16,["modelValue"])]),_:1})}}}),P=JSON.parse('{"title":"复选框组件","description":"","frontmatter":{},"headers":[],"relativePath":"component/toco-ui/ProFormField/checkbox.md","filePath":"component/toco-ui/ProFormField/checkbox.md"}'),b={name:"component/toco-ui/ProFormField/checkbox.md"},E=Object.assign(b,{setup(y){return(r,a)=>{const k=n("demo");return d(),m("div",null,[a[1]||(a[1]=i("h1",{id:"复选框组件",tabindex:"-1"},[s("复选框组件 "),i("a",{class:"header-anchor",href:"#复选框组件","aria-label":'Permalink to "复选框组件"'},"​")],-1)),p(k,{customClass:"demoblock-custom",sourceCode:`<template>
  <ProForm
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#999999","--shiki-dark":"#666666"}},"  },")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#999999","--shiki-dark":"#666666"}},"})")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#999999","--shiki-dark":"#666666"}},"</"),i("span",{style:{"--shiki-light":"#1E754F","--shiki-dark":"#4D9375"}},"script"),i("span",{style:{"--shiki-light":"#999999","--shiki-dark":"#666666"}},">")])])])],-1)])),default:e(()=>[p(f)]),_:1})])}}});export{P as __pageData,E as default};
