import{d as y,p as e,B as p,b as c,o as r,c as B,j as i,G as t,a as s,w as n}from"./chunks/framework.gaLehYSm.js";const D=y({__name:"mention.md.demo.41450f72",setup(d){const l=e("@"),a=e([{label:"Fuphoenixes",value:"Fuphoenixes"},{label:"kooriookami",value:"kooriookami"},{label:"Jeremy",value:"Jeremy"},{label:"btea",value:"btea"}]);return(h,k)=>{const o=p("ProField");return r(),c(o,{valueType:"mention",modelValue:l.value,"onUpdate:modelValue":k[0]||(k[0]=g=>l.value=g),fieldProps:{options:a.value,placeholder:"Please Input"}},null,8,["modelValue","fieldProps"])}}}),u=JSON.parse('{"title":"提及组件","description":"","frontmatter":{},"headers":[],"relativePath":"component/proField/mention.md","filePath":"component/proField/mention.md"}'),A={name:"component/proField/mention.md"},C=Object.assign(A,{setup(d){return(l,a)=>{const h=p("demo");return r(),B("div",null,[a[1]||(a[1]=i("h1",{id:"提及组件",tabindex:"-1"},[s("提及组件 "),i("a",{class:"header-anchor",href:"#提及组件","aria-label":'Permalink to "提及组件"'},"​")],-1)),t(h,{customClass:"demoblock-custom",sourceCode:`<template>
  <ProField
    valueType="mention"
    v-model="value"
    :fieldProps="{
