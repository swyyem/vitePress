import{d as y,p as o,B as e,b as c,o as p,c as B,j as i,G as t,a as s,w as n}from"./chunks/framework.gaLehYSm.js";const D=y({__name:"select.md.demo.4003f006",setup(r){const a=o(""),l=[{value:"Option1",label:"Option1"},{value:"Option2",label:"Option2"},{value:"Option3",label:"Option3"},{value:"Option4",label:"Option4"},{value:"Option5",label:"Option5"}];return(h,k)=>{const d=e("ProField");return p(),c(d,{valueType:"select",modelValue:a.value,"onUpdate:modelValue":k[0]||(k[0]=g=>a.value=g),fieldProps:{options:l}},null,8,["modelValue","fieldProps"])}}}),u=JSON.parse('{"title":"下拉选择组件","description":"","frontmatter":{},"headers":[],"relativePath":"component/proField/select.md","filePath":"component/proField/select.md"}'),A={name:"component/proField/select.md"},m=Object.assign(A,{setup(r){return(a,l)=>{const h=e("demo");return p(),B("div",null,[l[1]||(l[1]=i("h1",{id:"下拉选择组件",tabindex:"-1"},[s("下拉选择组件 "),i("a",{class:"header-anchor",href:"#下拉选择组件","aria-label":'Permalink to "下拉选择组件"'},"​")],-1)),t(h,{customClass:"demoblock-custom",sourceCode:`<template>
  <ProField
    valueType="select"
    v-model="value"
    :fieldProps="{
