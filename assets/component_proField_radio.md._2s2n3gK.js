import{d as c,p as B,B as p,b as D,o as r,c as A,j as i,G as t,a as s,w as e}from"./chunks/framework.KoO-uqrk.js";const C=c({__name:"radio.md.demo.44454ed0",setup(d){const l=B(""),a={expandTrigger:"hover"},h=k=>{console.log(k)},g=[{value:"consistency",label:"Consistency"},{value:"feedback",label:"Feedback"},{value:"efficiency",label:"Efficiency"},{value:"controllability",label:"Controllability"}];return(k,n)=>{const y=p("ProField");return r(),D(y,{valueType:"radio",modelValue:l.value,"onUpdate:modelValue":n[0]||(n[0]=o=>l.value=o),fieldProps:{options:g,props:a,onChange:h}},null,8,["modelValue","fieldProps"])}}}),m=JSON.parse('{"title":"单选框组件","description":"","frontmatter":{},"headers":[],"relativePath":"component/proField/radio.md","filePath":"component/proField/radio.md"}'),u={name:"component/proField/radio.md"},f=Object.assign(u,{setup(d){return(l,a)=>{const h=p("demo");return r(),A("div",null,[a[1]||(a[1]=i("h1",{id:"单选框组件",tabindex:"-1"},[s("单选框组件 "),i("a",{class:"header-anchor",href:"#单选框组件","aria-label":'Permalink to "单选框组件"'},"​")],-1)),t(h,{customClass:"demoblock-custom",sourceCode:`<template>
  <ProField
    valueType="radio"
    v-model="value"
    :fieldProps="{
