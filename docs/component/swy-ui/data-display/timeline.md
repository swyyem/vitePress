...
<template>
  <SwyTimeline>
    <SwyTimelineItem timestamp="2024-01-20 10:30">创建了项�?/SwyTimelineItem>
    <SwyTimelineItem timestamp="2024-01-19 15:20">完成了设计稿</SwyTimelineItem>
    <SwyTimelineItem timestamp="2024-01-18 09:00">开始需求分�?/SwyTimelineItem>
    <SwyTimelineItem timestamp="2024-01-17 14:00">召开项目启动�?/SwyTimelineItem>
  </SwyTimeline>
</template>
```
...
<template>
  <SwyTimeline>
    <SwyTimelineItem timestamp="2024-01-20" color="success">�?项目已上�?/SwyTimelineItem>
    <SwyTimelineItem timestamp="2024-01-18" color="primary">🚀 开发完�?/SwyTimelineItem>
  ...
  <div style="display: flex; flex-direction: column; gap: 30px;">
    <div>
      ...
      <SwyTimeline>
        ...
        <SwyTimelineItem timestamp="2024-01-18 09:00" placement="top">发布新版�?/SwyTimelineItem>
      </SwyTimeline>
    </div>
    ...
    <div>
      ...
      <SwyTimeline>
        ...
        <SwyTimelineItem timestamp="2024-01-18 09:00">发布新版�?/SwyTimelineItem>
      </SwyTimeline>
    </div>
  </div>
</template>
...
| --------- | ---------- | --------------------------------------------- | ------ |
| timestamp | 时间�?     | `string`                                      | �?     |
| placement | 时间戳位�? | `top / bottom`                                | bottom |
