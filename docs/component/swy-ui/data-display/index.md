...
const tableData = ref([
  { date: '2016-05-03', name: '王小�?, address: '上海市普陀区金沙江�?1518 �? },
  { date: '2016-05-02', name: '王小�?, address: '上海市普陀区金沙江�?1518 �? },
  { date: '2016-05-04', name: '王小�?, address: '上海市普陀区金沙江�?1518 �? },
])
</script>
```
...
<template>
  <SwyCollapse v-model="activeNames" @change="handleChange">
    <SwyCollapseItem name="1" title="一致�?Consistency">
