...
<template>
  <div style="height: 500px">
    ...
    >
      <template #toolbar-filters="{ onSearch, searchForm }">
        <ProField
          valueType="text"
          v-model="searchForm.campusOrganizationIdIs"
          :fieldProps="{
            filterable: true,
            clearable: true,
        ...
        />
        <el-checkbox v-model="searchForm.invalidFlagIs" @change="onSearch()" label="显示停用" />
      </template>
